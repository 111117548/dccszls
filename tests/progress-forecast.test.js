...
foundation.setActualStage(state, 1, { name: '预测测试' }, '测试当前阶段');
...
var prepared = foundation.getStageProgressDetail(state, 1);
...
foundation.updateStageProgress(state, 1, { forecastBaseDate: dateBefore(12) }, { name: '预测测试' });
var dispatched = foundation.getStageProgressDetail(state, 1);
...
var corrected = foundation.updateStageProgress(state, 1, {
...
var summary = foundation.updateStageProgress(state, 2, {
